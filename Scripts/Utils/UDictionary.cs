...
//[Serializable]
//public class SerializableDictionary<_Key, _Value> : IDisposable
//{
//    [SerializeField] private List<_Key> keys = new List<_Key>();
//    [SerializeField] private List<_Value> values = new List<_Value>();


//    public SerializableDictionary()
//    {
//        keys = new List<_Key>();
//        values = new List<_Value>();
//    }
...
//    public bool BContainsKey(_Key key)
//    {
//        return keys.Contains(key);
//    }

//    public void TryAdd(_Key key, _Value value)
//    {
...
//        values.Add(value);
//    }
//    public void TryRemove(_Key key)
//    {
//        if (!keys.Contains(key))
//        {
